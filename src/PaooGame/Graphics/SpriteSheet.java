...
public class SpriteSheet
{
    ...
    private static final int    tileHeight  = 63;   /*!< Inaltime unei dale din sprite sheet.*/
     ...
     */
    public BufferedImage crop(int x, int y, int flag)
    {
        ...
        if(flag==1) {
            return spriteSheet.getSubimage(x * 183, y * 171, 183, 171);
        }
